...
export async function scanReceipt(file) {
  try {
    ...
    const cleanedText = text.replace(/```(?:json)?\n/g, "").trim(); // Remove the code block markers

    //when we will get reponse. it will be in string format,
